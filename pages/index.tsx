    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-navy via-navy-dark to-navy">
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          {/* Content */}
          <div className="relative z-10 container mx-auto px-6 grid grid-cols-2 gap-12 items-center">
            {/* Left Side */}
            <div className="pr-12">
              <div className="mb-8">
                <p className="text-gold text-sm font-bold tracking-widest mb-4">LAVAGE & DÉTAILING</p>
                <h1 className="text-7xl font-black text-text-light leading-tight mb-8">
                  Éclat<br /><span className="text-gold">AUTO</span>
                </h1>
                <p className="text-text-light/80 text-lg leading-relaxed mb-4">
          ...
          >
            <div className="text-gold text-center">
              <p className="text-sm font-semibold mb-2">DÉCOUVRIR</p>
        ...
        {promotion && promotion.active && (
          <section ref={promotionsRef} className="py-20 px-6 bg-gradient-to-r from-gold/10 via-transparent to-gold/10 border-t-2 border-b-2 border-gold">
            <div className="container mx-auto">
              <div className="text-center mb-12">
                <p className="text-gold text-sm font-bold tracking-widest mb-4 animate-pulse">✨ {promotion.name.toUpperCase()} EN COURS</p>
                <h2 className="text-5xl font-black text-text-light mb-4">
                  Promotion<br /><span className="text-gold">{promotion.name}</span>
                </h2>
              </div>

              <div className="grid grid-cols-2 gap-12 items-center">
                <div className="bg-gradient-to-br from-gold/20 to-gold/5 border-2 border-gold rounded-2xl p-12 text-center">
                  <p className="text-gold text-sm font-bold tracking-widest mb-4">PRIX UNIQUE</p>
                  <p className="text-7xl font-black text-gold mb-4">
        ...
        {/* Services Section */}
        <section ref={servicesRef} className="py-24 px-6 bg-navy-dark/50 relative overflow-hidden">
          ...
          <div className="container mx-auto relative z-10">
            <div className="text-center mb-16">
              <p className="text-gold text-sm font-bold tracking-widest mb-4">NOS SERVICES</p>
              <h2 className="text-5xl font-black text-text-light mb-4">
              ...
              <div className="relative">
                ...
                {formulas.length > 2 && (
                  <>
                    <button
                      onClick={scrollLeft}
                      className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-gold/80 hover:bg-gold text-navy p-3 rounded-full transition shadow-lg"
                    >
                ...
                <div
                  ...
                  className="flex gap-8 overflow-x-auto pb-4 scroll-smooth px-12 snap-x snap-mandatory"
                  style={{ scrollBehavior: 'smooth' }}
                >
                  {formulas.map((formula) => (
                    <div
                      key={formula.id}
                      className={`flex-shrink-0 w-80 rounded-2xl p-8 transition transform hover:-translate-y-2 snap-center ${
                        formula.featured
                    ...
                    >
                      <div className="mb-6">
                        <p className="text-gold text-5xl font-black mb-2">${formula.price.toFixed(2)}</p>
                        {formula.featured && (
                          <p className="text-gold text-xs font-bold tracking-widest">PLUS POPULAIRE</p>
                        )}
                      </div>
                      <h3 className="text-text-light text-2xl font-bold mb-4">{formula.name}</h3>
                      ...
                      <button 
                        ...
                        className={`w-full py-3 rounded-lg font-bold text-lg transition transform hover:scale-105 ${
                          formula.featured
                ...
                {formulas.length > 2 && (
                  <>
                    <button
                      onClick={scrollRight}
                      className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-gold/80 hover:bg-gold text-navy p-3 rounded-full transition shadow-lg"
                    >
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section ref={ctaRef} className="py-24 px-6 relative overflow-hidden">
          ...
          <div className="container mx-auto relative z-10 text-center">
            <p className="text-gold text-sm font-bold tracking-widest mb-6">PRÊT À COMMENCER ?</p>
            <h2 className="text-5xl font-black text-text-light mb-8 leading-tight">
              Réservez votre<br /><span className="text-gold">créneau maintenant</span>
            </h2>
            <p className="text-text-light/80 max-w-2xl mx-auto mb-12 text-lg">
            ...
            <div className="flex gap-6 justify-center">
              <button 
                onClick={() => router.push('/reservation')}
                className="bg-gold hover:bg-yellow-400 text-navy px-10 py-4 rounded-lg font-bold text-lg transition transform hover:scale-105 hover:shadow-xl">
                RÉSERVER EN LIGNE
              </button>
              <button 
                onClick={handlePhoneCall}
                className="border-2 border-gold text-gold hover:bg-gold/10 px-10 py-4 rounded-lg font-bold text-lg transition">
                NOUS APPELER
              </button>
            </div>
          </div>
